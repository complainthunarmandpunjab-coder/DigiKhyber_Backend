...
Roll numbers follow the format: `DK-YYYY-XXXX`

- `HM`: Stands for "Digikhyber"
- `YYYY`: Current year (4 digits)
- `XXXX`: Random 4-digit number (1000-9999)

Example: `DK-2024-1234`
...
1. Generates a roll number in the format `DK-YYYY-XXXX`
