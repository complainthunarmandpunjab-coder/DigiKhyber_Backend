          ...
          <td style="padding: 30px;">
            ...
            <div style="background-color: #e9f7ef; border: 1px solid #b2f0c0; padding: 15px; border-radius: 8px; margin: 20px 0;">
              ...
              <p style="font-size: 14px; color: #155724; margin: 0;">
                If you have any questions about this transaction or need assistance, please contact our support team at <a href="mailto:contact@digikhyber.com" style="color: #079560;">contact@digikhyber.com</a>
              </p>
            </div>

            <p style="font-size: 16px; color: #555555;">
              Thank you,<br />
              <strong>Digikhyber Team</strong>
            </p>
          </td>
        </tr>
      </table>
