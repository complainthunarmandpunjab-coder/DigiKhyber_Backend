      ...
      <table align="center" width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border: 1px solid #ddd; margin-top: 20px;">
        ...
        <tr>
          <td style="padding: 30px;">
            ...
            <h3 style="color: #333333;">Thank you for applying to Digikhyber</h3>
            ...
            <div style="background-color: #f8f9fa; padding: 15px; border-radius: 8px; margin: 20px 0;">
              ...
              <p style="font-size: 14px; color: #555; margin: 0;">
                If you have any questions about your application, please don't hesitate to contact our support team at <a href="mailto:contact@digikhyber.com" style="color: #007bff;">contact@digikhyber.com</a>
              </p>
            </div>
