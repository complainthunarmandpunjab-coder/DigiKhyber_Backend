        ...
        <tr>
          <td style="padding: 30px;">
            ...
            <p style="font-size: 16px; color: #555555;">
              We noticed a login to your <strong>Digikhyber</strong> account on:
            </p>
            ...
            <div style="text-align: center; margin: 30px 0;">
              <a href="https://digikhyber.org.pk" style="background-color: #079560; color: #ffffff; padding: 12px 24px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;">
                Go to Dashboard
              </a>
            </div>
