      ...
      <table align="center" width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border: 1px solid #ddd; margin-top: 20px;">
        ...
        <tr>
          <td style="padding: 30px;">
            ...
            <h3 style="color: #333333;">Welcome to Digikhyber</h3>
            ...
            <p style="font-size: 16px; color: #555555;">
              Congratulations! Your email has been successfully verified. Your account is now active and you can access all features of Digikhyber.
            </p>
            ...
            <div style="text-align: center; margin: 30px 0;">
              <a href="https://digikhyber.org.pk/login" style="background-color: #079560; color: #ffffff; padding: 12px 24px; text-decoration: none; font-weight: bold; border-radius: 5px; margin: 10px; display: inline-block;">
            ...
            <p style="font-size: 14px; color: #999999;">
              For any questions or support, please contact our team at <a href="mailto:contact@digikhyber.com" style="color: #007bff;">contact@digikhyber.com</a>
            </p>

            <p style="font-size: 16px; color: #555555;">
              Welcome to the Digikhyber family!<br />
