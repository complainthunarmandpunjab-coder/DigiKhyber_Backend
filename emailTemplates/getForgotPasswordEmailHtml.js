      ...
      <table align="center" width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border: 1px solid #ddd; margin-top: 20px;">
        ...
        <tr>
          <td style="padding: 30px;">
            ...
            <p style="font-size: 16px; color: #555555;">
              We received a request to reset your password for your Digikhyber account. If you made this request, please click the button below to reset your password.
            </p>
            ...
            <div style="background-color: #e9f7ef; border: 1px solid #b2f0c0; padding: 15px; border-radius: 8px; margin: 20px 0;">
              ...
              <p style="font-size: 14px; color: #155724; margin: 0;">
                If you're having trouble resetting your password or didn't request this reset, please contact our support team at <a href="mailto:contact@digikhyber.com" style="color: #079560;">contact@digikhyber.com</a>
              </p>
            </div>
