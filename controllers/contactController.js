...
exports.contactUs = async (req, res) => {
  try {
        ...
        <tr>
          <td style="padding: 30px;">
            ...
            <p style="font-size: 14px; color: #999999;">
              This is an automated notification from the Digikhyber contact form.
            </p>
          </td>
        </tr>
      </table>
    ...
    const adminEmailResult = await sendEmail({
      email: process.env.ADMIN_EMAIL || "contact@digikhyber.org.pk",
      ...
      <table align="center" width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border: 1px solid #ddd; margin-top: 20px;">
        ...
        <tr>
          <td style="padding: 30px;">
            ...
            <p style="font-size: 16px; color: #555555;">
              Thank you for reaching out to Digikhyber. We have successfully received your message and our team will get back to you as soon as possible.
            </p>
            ...
            <div style="background-color: #fff3cd; border: 1px solid #ffeaa7; padding: 15px; border-radius: 8px; margin: 20px 0;">
              ...
              <p style="font-size: 14px; color: #856404; margin: 0;">
                For urgent matters, you can also contact us directly at <a href="mailto:contact@digikhyber.com" style="color: #079560;">contact@digikhyber.com</a> or call our helpline.
              </p>
            </div>

            <div style="text-align: center; margin: 30px 0;">
              <a href="https://digikhyber.org.pk" style="background-color: #079560; color: #ffffff; padding: 12px 24px; text-decoration: none; font-weight: bold; border-radius: 5px; margin: 10px; display: inline-block;">
                Visit Our Website
              </a>
            </div>
    ...
    const userEmailResult = await sendEmail({
      email: email,
      subject: "Thank You for Contacting Digikhyber",
      html: userEmailHtml,
      emailType: "contact",
    });
