...
```javascript
{
  ...
  rollNumber: String (required, format: DK-YYYY-XXXX),
...
- `rollNumber`: Roll number in format DK-YYYY-XXXX
...
formData.append('rollNumber', 'DK-2024-1234');
