...
module.exports = {
  ...
  emails: {
    ...
    verification: {
      email: process.env.VERIFICATION_EMAIL || 'noreply@digikhyber.com',
      name: 'Digikhyber - No Reply'
    },
    
    // Admission Test Email Notification & Challan Email Notification & Certificate Notification
    admissions: {
      email: process.env.ADMISSIONS_EMAIL || 'admissions@digikhyber.com',
      name: 'Digikhyber - Admissions'
    },
    
    // Password Reset & Scholarship Card & Contact
    contact: {
      email: process.env.CONTACT_EMAIL || 'contact@digikhyber.com',
      name: 'Digikhyber - Contact'
    }
  }
}; 